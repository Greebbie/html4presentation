...
"a deck" as HTML, **follow the `html-deck` skill** at:
...
1. Read `skills/html-deck/SKILL.md` and `skills/html-deck/references/convention.md`.
...
4. Embed `skills/html-deck/assets/deck-editor.inline.html` **verbatim** right before
...
- The editor in `skills/html-deck/assets/deck-editor.inline.html` is the single source
